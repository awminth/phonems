...
const DamageReport: React.FC = () => {
    ...
    const handleExport = () => {
        ...
        exportStyledExcel(title, headers, excelData, `damage_report_${new Date().toISOString().split('T')[0]}.xlsx`, 'Damage Report');
    };
        ...
        <div className="h-screen bg-gray-900 text-white flex flex-col font-sans overflow-hidden">
            <header className="bg-gray-800 shadow-md p-4 flex items-center justify-between border-b border-gray-700 h-16 shrink-0">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-xl font-bold">Damage Report</h1>
                </div>
            </header>
